      ...
      case 's':
        {
          ...
          if (authSession === null || authSession === void 0 ? void 0 : authSession.accessToken) {
            (0, _log().default)(_chalk().default.yellow('Please remove the EXPO_TOKEN environment var to sign out.'));
          } else if (authSession === null || authSession === void 0 ? void 0 : authSession.sessionSecret) {
